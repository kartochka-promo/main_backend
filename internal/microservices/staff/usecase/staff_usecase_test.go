...
//	mailGRPCMock "2020_1_drop_table/internal/microservices/mail/delivery/grpc/mocks"
...
//	s := usecase.NewStaffUsecase(srepo, cafeRepo, grpcMailClient, timeout)
//
...
//			empty, sql.ErrNoRows)
//		realUser, realErr := s.Register(emptyContext, testCase.user, "")
